...
class BagOfWords(Document):
    def features(self):
        ...
        return set(nltk.word_tokenize(self.data.lower()))
...
class MaxEntTest(TestCase):
    ...
    #     # return (names[:500], names[500:6000], names[6000:])
    #
    #
    ...
    def split_review_corpus(self, document_class):
        ...
        shuffle(reviews)
        print(len(reviews))
        # return (reviews[:10000], reviews[10000:11000], reviews[12000:20000])
        return (reviews[:50000], reviews[100000:101000], reviews[101000:120000])
